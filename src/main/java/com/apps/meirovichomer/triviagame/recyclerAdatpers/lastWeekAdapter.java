...
public class lastWeekAdapter extends RecyclerView.Adapter<lastWeekAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            score = (TextView) view.findViewById(R.id.score_last_week_row);
            player_name = (TextView) view.findViewById(R.id.name_last_week_row);
            rankImage = (ImageView) view.findViewById(R.id.rank_last_week_image);
        }
    }


    public lastWeekAdapter(ArrayList<topSessionsClass> allSessions) {
        this.allSessions = allSessions;
    }

    @Override
    public lastWeekAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.last_week_row, parent, false);

        return new lastWeekAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(lastWeekAdapter.MyViewHolder holder, int position) {
