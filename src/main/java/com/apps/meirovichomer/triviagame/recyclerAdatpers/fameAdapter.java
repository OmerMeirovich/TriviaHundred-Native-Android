...
public class fameAdapter extends RecyclerView.Adapter<fameAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            score = (TextView) view.findViewById(R.id.score_fame_row);
            player_name = (TextView) view.findViewById(R.id.name_fame_row);
            rankImage = (ImageView) view.findViewById(R.id.rank_fame_image);
        }
    }


    public fameAdapter(ArrayList<topSessionsClass> allSessions) {
    ...
    public fameAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fame_list_row, parent, false);

        return new fameAdapter.MyViewHolder(itemView);
    }
