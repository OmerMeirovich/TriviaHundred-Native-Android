...
import com.apps.meirovichomer.triviagame.recyclerAdatpers.lastWeekAdapter;
 ...
 * {@link LastWeekFragment.OnFragmentInteractionListener} interface
...
public class LastWeekFragment extends Fragment {
    ...
    private lastWeekAdapter mAdapter;
     ...
     * @return A new instance of fragment LastWeekFragment.
     */
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        lastWeekSessionRetrofit();
    }


    private void lastWeekSessionRetrofit() {
        RetrofitTriviaInterface mApiService = this.getInterfaceService();
        data mapRequest = new data();
        final Call<TopSessionClass> mService = mApiService.getTopFive(mapRequest.getParamsData("getTopLastWeek"));
    ...
    private void populateRecycleView(ArrayList<topSessionsClass> allSessions) {
        ...
        recyclerView = (RecyclerView) getActivity().findViewById(R.id.last_week_recycler);
        mAdapter = new lastWeekAdapter(allSessions);
