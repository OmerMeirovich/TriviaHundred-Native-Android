...
import com.apps.meirovichomer.triviagame.recyclerAdatpers.lastDayAdapter;
 ...
 * {@link LastDayFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link LastDayFragment#newInstance} factory method to
...
public class LastDayFragment extends Fragment {
    ...
    private lastDayAdapter mAdapter;
     ...
     * @return A new instance of fragment LastDayFragment.
     */
    public static LastDayFragment newInstance(String param1, String param2) {
        LastDayFragment fragment = new LastDayFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_last_day, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        lastDaySessionRetrofit();
    }


    // Get properties from user into the shared prefs.
    private void lastDaySessionRetrofit() {
        RetrofitTriviaInterface mApiService = this.getInterfaceService();
        data mapRequest = new data();
        final Call<TopSessionClass> mService = mApiService.getTopFive(mapRequest.getParamsData("getTopLastDay"));
    ...
    private void populateRecycleView(ArrayList<topSessionsClass> allSessions) {
        ...
        recyclerView = (RecyclerView) getActivity().findViewById(R.id.last_day_recycler);
        mAdapter = new lastDayAdapter(allSessions);
